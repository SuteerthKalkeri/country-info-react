...
const Search = () => {
  ...
  //fetch('https://restcountries.com/v3.1/all').then(res => res.json()).then(data => console.log(data)).catch(err => err)

  return (
    <>
      <div className="search">
      <AsyncPaginate placeholder="Search for a country"
      debounceTimeout={600}
      ...
      <Flag selectedCountryName={selectedCountryName}/>
    </>
  )
